                ...
                <div ref={ref} className="print-template">
                    ...
                    <div className="print-header">
                        ...
                        <div className="print-header__qr">
                            ...
                            <div className="qr-text">
                                <p className="qr-note-bold">Quý khách vui lòng quét</p>
                    ...
                    <table className="print-table">
                        ...
                        <tbody>
                            ...
                            {[...Array(Math.max(0, 5 - (details?.length || 0)))].map((_, i) => (
                        ...
                        <tfoot>
                            {(() => {
                                ...
                                return (
                                    <>
                                        <tr>
                                            <td colSpan="5" className="text-right font-bold">Tổng tiền hàng</td>
                                            <td className="text-right font-bold">{numFmt(totalListedTienHang)}</td>
                                        </tr>
                                        <tr>
                                            <td colSpan="5" className="text-right font-bold">Chiết khấu/ Phụ thu</td>
                                            <td className="text-right font-bold">{numFmt(totalDiscount)}</td>
                                        </tr>
                                        <tr>
                                            <td colSpan="5" className="text-right font-bold">Tổng thanh toán</td>
                                            <td className="text-right font-bold">{numFmt(finalPayment)}</td>
                                        </tr>
                                    </>
                                );
                            })()}
