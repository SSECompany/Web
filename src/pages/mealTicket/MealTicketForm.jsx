...
import { setBeds, setMasterData, setShowMealDetails, setShowRoomSelection } from '../../modules/meal/store/meal';
import './MealTicketForm.css';

const MealTicketForm = () => {
    const dispatch = useDispatch();
    const mealDetails = useSelector((state) => state.meals.masterData);
