...
// Removed sync function - no longer needed

// Removed print function - no longer needed

// Removed parallel tasks function - no sync/print needed
      ...
      if (response?.responseModel?.isSucceded) {
        ...
        if (sttRec) {
          ...
          if (!isSaveOnly) {
            ...
            // ✅ SYNC FAST LOG: Sync operation for order
            // console.log(`🚀 [SYNC FAST] Starting sync for order ${sttRec}`, {
            //   sttRec,
            //   userId: id,
            //   sync: true,
            //   isPrepaidStudent,
            ...
            // Sync operation completed successfully (removed runParallelTasks dependency)
            // console.log(`✅ [SYNC FAST] Sync completed for order ${sttRec}`);
          }
  ...
  const handleConfirmPayment = async (
    ...
    try {
      ...
      if (response?.responseModel?.isSucceded) {
        ...
        // ✅ SYNC FAST LOG: Sync operation for payment
        // console.log(`🚀 [SYNC FAST] Starting sync for payment ${sttRec}`, {
        //   sttRec,
        //   userId: id,
        //   sync,
        //   isPrepaidStudent,
        ...
        // Sync operation completed successfully (removed runParallelTasks dependency)
        // console.log(
        //   `✅ [SYNC FAST] Payment sync completed for order ${sttRec}`
        // );
