...
const CustomerForm = () => {
  ...
  const handleEdit = (record) => {
    setCurrentRecord(record.ma_hinh_thuc);
  ...
  const handleDelete = (keys) => {
    SoFuckingUltimateApi({
      store: "api_delete_customer_forms",
      data: {
        id: keys.replaceAll(" ", ""),
        userid: 0,
      },
  ...
  return (
    <div className="default_list_layout page_default">
      ...
      <ConfirmDialog
        ...
        title="Xoá"
        description={`Xoá mã : ${currentItemSelected.ma_hinh_thuc}, tên hình thức: ${currentItemSelected.ten_hinh_thuc}`}
        handleOkModal={handleDelete}
        handleCloseModal={handleCloseDeleteDialog}
        keys={
          currentItemSelected.ma_hinh_thuc
            ? currentItemSelected.ma_hinh_thuc
