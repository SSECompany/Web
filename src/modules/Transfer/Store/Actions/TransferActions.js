...
export const setCurrentRetailOrder = (data) => {
  try {
    store.dispatch(TransferActions.setCurrentOrder(data));
  } catch (error) {
    console.log(error);
  }
};
...
export const setRetailOrderList = (data) => {
  try {
    store.dispatch(TransferActions.setListOrder(data));
  } catch (error) {
    console.log(error);
  }
};
...
export const setRetailOrderScanning = (data) => {
  try {
    store.dispatch(TransferActions.setIsScanning(data));
  } catch (error) {
    console.log(error);
  }
};
...
export const resetRetailOrder = (data) => {
  try {
    store.dispatch(TransferActions.reset());
  } catch (error) {
    console.log(error);
  }
};
...
export const getValueParam = (key) => {
  try {
    const { fetchListParams } = store.getState().TransferReducer;
...
export const setFetchListParams = (data) => {
  try {
    ...
    store.dispatch(
      TransferActions.setFetchListParams({ ...fetchListParams, ...data })
    );
  } catch (error) {
    console.log(error);
  }
...
//---------------------------------------------------------------------------------------------------------------------------------------------
export const actionSetOpenTransfer = async (payload) => {
  store.dispatch(TransferActions.setOpenListTransfer(payload));
};
export const modifyIsFormLoading = async (params) => {
  store.dispatch(TransferActions.setIsFormLoading(params));
};

export const modifyIsOpenPromotion = async (params) => {
  store.dispatch(TransferActions.setIsOpenPromotion(params));
};
