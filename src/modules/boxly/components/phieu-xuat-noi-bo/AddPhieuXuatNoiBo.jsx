  ...
  const handleSubmit = async () => {
    try {
      ...
      const result = await submitPhieu(
        "v1/web/tao-phieu-xuat-noi-bo",
        payload,
        "Tạo phiếu xuất nội bộ thành công"
      );
      ...
      console.error("Lỗi khi tạo phiếu xuất nội bộ:", error);
    } finally {
      setLoading(false);
    }
  };
...
export default AddPhieuXuatNoiBo;
