...
const ListPhieuXuatDieuChuyen = () => {
  ...
  // Key để lưu filters riêng cho phiếu xuất điều chuyển
  const FILTER_STORAGE_KEY = "phieu_xuat_dieu_chuyen_filters";
        ...
        render: (statusname, record) => {
          ...
          const getStatusTextLocal = (status) => {
            const statusMap = {
              ...
              2: screenSize === "mobile" ? "Chuyển KTTH" : "Chuyển KTTH",
              3: screenSize === "mobile" ? "Chuyển SC" : "Chuyển vào SC",
            };
            return statusMap[status] || "Không xác định";
          };
