...
export default function VietQR({ amount, soChungTu, size = 100, account: propsAccount, bankId: propsBankId }) {
  const account = propsAccount || process.env.REACT_APP_VIETQR_ACCOUNT;
  const bankId = propsBankId || process.env.REACT_APP_VIETQR_BANK_ID;
